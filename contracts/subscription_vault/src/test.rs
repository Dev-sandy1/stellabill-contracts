...
fn test_deposit_funds_event_payload() {
    ...
    let event_data: crate::FundsDepositedEvent = <crate::FundsDepositedEvent as soroban_sdk::FromVal<soroban_sdk::Env, soroban_sdk::Val>>::from_val(&env, &deposit_event.2);
...
fn test_blocklist_add_and_remove_events_capture_reason_variants() {
    ...
    let added: crate::BlocklistAddedEvent = <crate::BlocklistAddedEvent as soroban_sdk::FromVal<
        soroban_sdk::Env,
        soroban_sdk::Val,
    >>::from_val(&test_env.env, &add_event.2);
    ...
    let removed: crate::BlocklistRemovedEvent =
        <crate::BlocklistRemovedEvent as soroban_sdk::FromVal<
            soroban_sdk::Env,
            soroban_sdk::Val,
        >>::from_val(&test_env.env, &remove_event.2);
...
fn test_admin_rotation_affects_recovery_operations() {
    ...
    test_env.client.recover_stranded_funds(
        ...
        &recipient,
        &1_000_000i128,
        &soroban_sdk::String::from_str(&test_env.env, "test-recovery-1"),
        &RecoveryReason::UserOverpayment,
    );
